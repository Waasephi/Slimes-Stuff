...
namespace OurStuffAddon.Backgrounds
{
	public class RuinBackroundSurface : ModSurfaceBgStyle
	{
		...
		{
			return !Main.gameMenu && Main.player[Main.myPlayer].GetModPlayer<MyPlayer>().ZoneRuin;   //ZoneCustomBiome is the bool that u add in MyPlayer so make sure they are the same
		}
