...
namespace OurStuffAddon.Tiles
{
	public class RebornSapling : ModTile
	{
		public override void SetDefaults()
		{
			...
			TileObjectData.newTile.AnchorValidTiles = new[] { TileType<PhoenixMoss>() };
			...
			TileObjectData.newSubTile.AnchorValidTiles = new int[] { TileType<PhoenixSand>() };
			TileObjectData.addSubTile(1);
			TileObjectData.addTile(Type);
			sapling = true;
			ModTranslation name = CreateMapEntryName();
			name.SetDefault("Reborn Sapling");
			AddMapEntry(new Color(150, 100, 100), name);
			dustType = DustType<PhoenixDust>();
