...
namespace OurStuffAddon.Items.SpiritDamageClass
{
	...
	public class ChloroGem : SpiritDamageItem
	{
		...
		{
			DisplayName.SetDefault("Chloro Gem");
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.ItemType<HalloGem>());
		...
		{
			bool isSpiritCaster = sitem.type == ModContent.ItemType<ChloroGem>();
