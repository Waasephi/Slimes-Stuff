...
namespace OurStuffAddon.Items.SpiritDamageClass
{
	...
	public class ElectrumShooter : SpiritDamageItem
	{
		...
		{
			DisplayName.SetDefault("Electrum Shooter");
		...
		{
			bool isSpiritCaster = sitem.type == ModContent.ItemType<SpiritCryodizer>();
