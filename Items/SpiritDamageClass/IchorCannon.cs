...
namespace OurStuffAddon.Items.SpiritDamageClass
{
	...
	public class IchorCannon : SpiritDamageItem
	{
		...
		{
			DisplayName.SetDefault("Ichor Cannon");
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.ItemType<TaintedCore>());
		...
		{
			bool isSpiritCaster = sitem.type == ModContent.ItemType<IchorCannon>();
