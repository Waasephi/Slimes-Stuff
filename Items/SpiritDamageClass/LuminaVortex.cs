...
namespace OurStuffAddon.Items.SpiritDamageClass
{
	...
	public class LuminaVortex : SpiritDamageItem
	{
		...
		{
			DisplayName.SetDefault("Lumina Vortex");
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.ItemType<LuminaFragment>(), 18);
		...
		{
			int numberProjectiles = 1 + Main.rand.Next(1); // 1 or 4 shots
		...
		{
			bool isSpiritCaster = sitem.type == ModContent.ItemType<LuminaVortex>();
