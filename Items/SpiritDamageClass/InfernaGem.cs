...
namespace OurStuffAddon.Items.SpiritDamageClass
{
	...
	public class InfernaGem : SpiritDamageItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Inferna Gem");
        ...
        {
            bool isSpiritCaster = sitem.type == OurStuffAddon.Instance.ItemType<InfernaGem>();
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddRecipeGroup("OurStuffAddon:EvilGem");
