...
namespace OurStuffAddon.Items.SpiritDamageClass
{
	...
	public class SkyRazorator : SpiritDamageItem
	{
		...
		{
			DisplayName.SetDefault("Sky Razorator");
			Tooltip.SetDefault("Takes the air and makes it so sharp it solidifies." +
		...
		{
			bool isSpiritCaster = sitem.type == ModContent.ItemType<SkyRazorator>();
