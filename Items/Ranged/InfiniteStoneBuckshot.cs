...
namespace OurStuffAddon.Items.Ranged
{
    public class InfiniteStoneBuckshot : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.value = 1;
            item.rare = 1;
            item.shoot = mod.ProjectileType("StoneBuckshotProjectile");   //The projectile shoot when your weapon using this ammo
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(mod, "StoneBuckshot", 4000);
