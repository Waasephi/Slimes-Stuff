...
namespace OurStuffAddon.Items.Accessories.GrapplingHooks
{
	public class SeafoamHook : ModItem
	{
		...
		{
			DisplayName.SetDefault("Seafoam Hook");
		}
	...
	public class SeafoamHookProjectile : ModProjectile
	{
		public override void SetStaticDefaults()
		{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			while (distance > 30f && !float.IsNaN(distance))
			{
				...
				//Draw chain
				spriteBatch.Draw(mod.GetTexture("Items/Accessories/GrapplingHooks/SeafoamHookChain"), new Vector2(center.X - Main.screenPosition.X, center.Y - Main.screenPosition.Y),
