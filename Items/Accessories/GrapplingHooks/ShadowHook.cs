...
namespace OurStuffAddon.Items.Accessories.GrapplingHooks
{
    internal class ShadowHook : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(mod, "ShadowCrystal", 15);
    ...
    internal class ShadowHookProjectile : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            while (distance > 30f && !float.IsNaN(distance))
            {
                ...
                //Draw chain
                spriteBatch.Draw(mod.GetTexture("Items/Accessories/GrapplingHooks/ShadowHookChain"), new Vector2(center.X - Main.screenPosition.X, center.Y - Main.screenPosition.Y),
