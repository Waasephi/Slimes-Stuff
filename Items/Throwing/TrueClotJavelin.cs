...
{
    public class TrueClotJavelin : ModItem

    {

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("True Clot Javelin");
        }
        public override void SetDefaults()
        {
            ...
            item.shoot = mod.ProjectileType("ClotJavelinProjectile");
        ...
        public override void AddRecipes()  //How to craft this item
        {
            ...
            recipe.AddIngredient(mod, "ClotJavelin");
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            Projectile.NewProjectile(position.X - 20, position.Y, speedX *= 2, speedY *= 2, mod.ProjectileType("TrueBloodJavelinProjectile"), damage, knockBack, player.whoAmI);
            return true;
        }
    }
}