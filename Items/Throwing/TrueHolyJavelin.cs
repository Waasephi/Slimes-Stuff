...
{
    public class TrueHolyJavelin : ModItem

    {

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("True Holy Javelin");
        }
        public override void SetDefaults()
        {
            ...
            item.shoot = mod.ProjectileType("HolyJavelinProjectile");
        ...
        public override void AddRecipes()  //How to craft this item
        {
            ...
            recipe.AddIngredient(mod, "HolyJavelin");
