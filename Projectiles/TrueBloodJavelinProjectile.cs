...
{
    public class TrueBloodJavelinProjectile : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            projectile.penetrate = 10;      //this is how many enemy this projectile penetrate before disappear
        ...
        public override void AI()
        {
            ...
            {
                projectile.velocity.Y = projectile.velocity.Y + 10f;    // projectile fall velocity
                projectile.velocity.X = projectile.velocity.X * 4f;    // projectile velocity
            }
        }
