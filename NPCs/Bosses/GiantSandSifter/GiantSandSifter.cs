...
namespace OurStuffAddon.NPCs.Bosses.GiantSandSifter
{
    [AutoloadBossHead]
    class GiantSandSifterHead : GiantSandSifter
    {
        public override string Texture { get { return "OurStuffAddon/NPCs/Bosses/GiantSandSifter/GiantSandSifterHead"; } }
        ...
        public override void SetDefaults()
        {
            ...
            npc.boss = true;
            music = mod.GetSoundSlot(SoundType.Music, "Sounds/Music/GiantSandSifterTheme");
        }
    ...
    class GiantSandSifterBody : GiantSandSifter
    {
        public override string Texture { get { return "OurStuffAddon/NPCs/Bosses/GiantSandSifter/GiantSandSifterBody"; } }
    ...
    class GiantSandSifterTail : GiantSandSifter
    {
        public override string Texture { get { return "OurStuffAddon/NPCs/Bosses/GiantSandSifter/GiantSandSifterTail"; } }
            ...
            if (!Main.expertMode)
            {
                ...
                switch (loots)
                {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        Item.NewItem(npc.getRect(), mod.ItemType("SifterStaff"), Main.rand.Next(1, 1));
                        break;
                }
            }
    ...
    public abstract class Worm : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            npc.dontTakeDamage = !Main.player[npc.target].ZoneUndergroundDesert;
            if (npc.localAI[1] == 0f)
            {
                npc.localAI[1] = 1f;
                Init();
